...
import { IconButton, PrimaryBtn } from "../components/button";
...
import { RatingBtn, RatingWidget } from "../components/delivered/rating-btn";
...
const Delivered1: NextPage<Props> = () => {
  ...
  return (
    <AppLayout background="./img/background-3.png">
              ...
              >
                ...
                >
                  <ChatRoom>
                    ...
                    <RateCourierBtn onClick={showConfirmModal}>
                      <div>
      ...
      <Modal
        ...
        footer={[
          <PrimaryBtn size="middle" onClick={handleOk}>
            Confirm
          </PrimaryBtn>,
        ]}
      >
        <ModalConfirmMessage>Delivery Complete</ModalConfirmMessage>
        <P2 style={{ textAlign: "center" }}>Give your courier a rating!</P2>
        <RatingWidget>
          <RatingBtn type="like">
            <Icon icon="thumb-up" />
          </RatingBtn>
          <RatingBtn type="dislike">
